...
Revision ID: d93c898fd5e9
Revises:
Create Date: 2024-08-09 14:30:18.848489
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_gps_feed_id"), "feed", ["id"], unique=False, schema="gps")
    op.create_table(
        "feed_item",
        sa.Column("name", sa.String(), nullable=True),
        sa.Column("id", sa.UUID(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_gps_feed_id"), table_name="feed", schema="gps")
    op.drop_table("feed", schema="gps")
    # ### end Alembic commands ###
